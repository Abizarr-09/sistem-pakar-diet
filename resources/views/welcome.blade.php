...
<body>
    <div class="hero">
        <div class="content">
            ...
            <h1>Sistem Pakar<br>Penentuan Jenis Diet</h1>

            <p class="subtitle">
                Temukan jenis diet yang tepat untuk kondisi kesehatan Anda berdasarkan analisis penyakit dengan metode Forward Chaining
            </p>

            <div class="stats">
                <div class="stat">
                    <div class="stat-value">12</div>
                    <div class="stat-label">Penyakit Khusus</div>
                </div>
                <div class="stat">
            ...
            <div class="features">
                <div class="feature-card">
                    ...
                    <p>Pilih penyakit yang Anda derita untuk mendapatkan rekomendasi diet yang tepat</p>
                </div>
                <div class="feature-card">
                ...
                <div class="feature-card">
                    ...
                    <p>Semua hasil diagnosis tersimpan dan bisa dilihat kapan saja</p>
                </div>
            </div>
            ...
            <div class="footer">
                <p>Sistem Pakar Penentuan Jenis Diet &mdash; Laravel + Tailwind CSS</p>
            </div>
        </div>
    </div>
</body>
