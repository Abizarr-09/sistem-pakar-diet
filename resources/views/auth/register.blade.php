<x-guest-layout>
    <div class="text-center mb-6">
        ...
        <p class="text-sm text-gray-500 mt-1">Daftar untuk mulai menggunakan sistem pakar diet</p>
    </div>
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <p class="text-center text-sm text-gray-500 mt-6">
            Sudah punya akun?
            <a href="{{ route('login') }}" class="text-emerald-600 hover:text-emerald-700 font-semibold">Masuk di sini</a>
        </p>
    </form>
</x-guest-layout>
